...
//pages
const Vendor = React.lazy(() => import('./views/pages/vendor/Vendor.js'))
const Customer = React.lazy(() => import('./views/pages/customer/Customer.js'))
const Vehicle = React.lazy(() => import('./views/pages/vehicle/Vehicle.js'))
const Feedback = React.lazy(() => import('./views/pages/feedback/Feedback.js'))
